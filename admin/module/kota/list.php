<?php
    ...
    $where = false;
    $search_url =false;
    $kota = query("select * from $module $where LIMIT $mulai_dari,$data_per_halaman");
    // tombol cari ditekan
    // if (isset($_POST['cari'])) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="main-card mb-3 card">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">List kota</h5>
                                            ...
                                            <table class="mb-0 table table-striped text-center table-hover ">
                                                ...
                                                <?php
                                                    ...
                                                    foreach($kota as $kota_part): ?>
                                                            <tr>
                                                                <th scope="row"><?= $no ?></th>
                                                                <td><?= $kota_part["nama_kota"] ?></td>
                                                                <td><?= rupiah($kota_part["harga"]) ?></td>
                                                                <td><?= ucwords($kota_part["status"]) ?></td>
                                                                <td>
                                                                    <form action="module/proses.php" method="POST">
                                                                        <input type="hidden" name="id" value="<?= $kota_part["kota_id"] ?>">
