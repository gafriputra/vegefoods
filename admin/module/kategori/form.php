                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="" id="#" role="tabpanel">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">Informasi Kategori</h5>
                                                <div class="position-relative row form-group">
                                                    <label for="validationCustom01" class="col-sm-2 col-form-label">Nama Kategori</label>
                                                        <div class="col-sm-10">
                                                            <input name="nama_kategori" id="validationCustom01" placeholder="" type="text" class="form-control" value="<?= $queryForm['nama_kategori']?>" required>
                                                        </div>
                                                ...
                                                <div class="position-relative row form-group"><label for="deskripsi" class="col-sm-2 col-form-label">Keterangan Produk</label>
                                                        <div class="col-sm-10"><textarea name="keterangan" id="deskripsi" class="form-control"><?= $queryForm['keterangan']?></textarea></div>
                                                </div>
