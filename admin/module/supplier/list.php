<?php
    ...
    $where = false;
    $search_url =false;
    $supplier = query("select * from $module $where LIMIT $mulai_dari,$data_per_halaman");
    // tombol cari ditekan
    // if (isset($_POST['cari'])) {
                                            ...
                                            <table class="mb-0 table table-striped text-center table-hover ">
                                                ...
                                                <?php
                                                    ...
                                                    foreach($supplier as $supplier_part): ?>
                                                            <tr>
                                                                <th scope="row"><?= $no ?></th>
                                                                <td><?= $supplier_part["nama_supplier"] ?></td>
                                                                <td><?= substr($supplier_part["alamat"],0,30) ?>......</td>
                                                                <td><?= $supplier_part["email"] ?></td>
                                                                <td><?= ucwords($supplier_part["status"]) ?></td>
                                                                <td>
                                                                    <form action="module/proses.php" method="POST">
                                                                        <input type="hidden" name="id" value="<?= $supplier_part["supplier_id"] ?>">
