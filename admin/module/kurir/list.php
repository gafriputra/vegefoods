<?php
    ...
    $where = false;
    $search_url =false;
    $kurir = query("select * from $module $where LIMIT $mulai_dari,$data_per_halaman");
    // tombol cari ditekan
    // if (isset($_POST['cari'])) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <h5 class="card-title">List kurir</h5>
                                            ...
                                            <table class="mb-0 table table-striped text-center table-hover ">
                                                ...
                                                <?php
                                                    ...
                                                    foreach($kurir as $kurir_part): ?>
                                                            <tr>
                                                                <th scope="row"><?= $no ?></th>
                                                                <td><?= $kurir_part["nama_ekspedisi"] ?></td>
                                                                <td><?= substr($kurir_part["alamat"],0,30) ?>......</td>
                                                                <td><?= $kurir_part["email"] ?></td>
                                                                <td><?= ucwords($kurir_part["status"]) ?></td>
                                                                <td>
                                                                    <form action="module/proses.php" method="POST">
                                                                        <input type="hidden" name="id" value="<?= $kurir_part["kurir_id"] ?>">
