<?php
    $barang = query("SELECT barang.* FROM barang
					...
					ORDER BY barang_id DESC LIMIT 8");
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              ...
	              <p><a href="#produk" class="btn btn-primary">View Details</a></p>
	            </div>
				...
				<div class="row">
							...
							<div class="col-md-6 order-md-last align-items-stretch d-flex">
								<div class="category-wrap-2 ftco-animate img align-self-stretch d-flex" style="background-image: url(images/category.jpg);">
									<div class="text text-center">
										...
										<p><a href="?page=shop" class="btn btn-primary">Shop now</a></p>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/category-1.jpg);">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="?page=shop&kategori_id=123246">Fruits</a></h2>
									</div>
								</div>
								<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(images/category-2.jpg);">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="?page=shop&kategori_id=123245">Vegetables</a></h2>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-4">
						<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/category-3.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="?page=shop&kategori_id=123249">Juices</a></h2>
							</div>		
						</div>
						<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(images/category-4.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="?page=shop&kategori_id=123250">Dried</a></h2>
							</div>
						</div>
					</div>
				</div>
                      ...
                      <div class="text py-3 pb-4 px-3 text-center">
                        ...
                        <div class="bottom-area d-flex px-3">
                          <div class="m-auto d-flex">
                            ...
                            <a href="tambah_keranjang.php?barang_id=<?= $barang_part["barang_id"]?>" class="buy-now d-flex justify-content-center align-items-center mx-1">
